...
@section('content')
    ...
    <div class="surat_container" data-aos="fade-up" data-aos-delay="50" data-aos-duration="2000">
        ...
        <div class="d-flex w-100 justify-content-start pegawai-button gap-3 mb-3">
            <a href="{{ url('/creatediklat/'.$pegawai->id) }}" class="btn btn-md btn-success">Tambah</a>
            <a href="{{ url('/exportdiklat/'.$pegawai->id) }}" class="btn btn-md btn-warning text-white">Export</a>
