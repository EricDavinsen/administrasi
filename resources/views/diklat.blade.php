                ...
                <div id="content" class="p-4 p-md-5">
                    ...
                    <div class="surat_container"  data-aos="fade-up" data-aos-delay="50" data-aos-duration="2000">
                        ...
                        <div class="d-flex w-100 justify-content-start pegawai-button">
                            <a href="{{ url('/creatediklat/'.$pegawai->id) }}" class="btn btn-md btn-success m-3">Tambah</a>
                            <a href="{{ url('/exportdiklat/'.$pegawai->id) }}" class="btn btn-md btn-warning text-white  m-3">Export</a>
