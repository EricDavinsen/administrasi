...
@section('content')
    ...
    <div class="surat_container" data-aos="fade-up" data-aos-delay="50" data-aos-duration="2000">
        ...
        <div class="d-flex w-100 justify-content-start pegawai-button gap-3 mb-3">
            <a href="{{ url('/createdatabpjs/'.$pegawai->id) }}" class="btn btn-md btn-success">Tambah</a>
            <a href="{{ url('/exportbpjs/'.$pegawai->id) }}" class="btn btn-md btn-warning text-white">Export</a>
            <a href="{{ url('/dashboardpegawai/'.$pegawai->id) }}" class="btn btn-md btn-info text-white">Back</a>
        </div>
    </div>
