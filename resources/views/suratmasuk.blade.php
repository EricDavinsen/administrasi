                ...
                <div id="content" class="p-4 p-md-5">
                    ...
                    <div class="surat_container"  data-aos="fade-up" data-aos-delay="50" data-aos-duration="2000">
                        ...
                        <div class="d-flex w-100 justify-content-end">
                            <a href="{{ url('/createsuratmasuk') }}" class="btn btn-md btn-success m-3">Tambah</a>
                            ...
                            <div class="modal-dialog" role="document">
                                <div class="modal-content">
                                    <div class="modal-header">
                                        <h5 class="modal-title" id="exampleModalLabel">Export Surat Masuk</h5>
                                        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                        <span aria-hidden="true">&times;</span>
                                        </button>
                                    </div>
                                    <form action="{{ url('/exportsuratmasuk') }}" method="GET" enctype="multipart/form-data">
                                        @csrf
                                            <div class="modal-body">
                                                <h5>Apakah anda ingin mengexport tabel data surat masuk?</h5>
                                            </div>
