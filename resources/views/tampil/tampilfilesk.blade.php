    ...
    <body>
        <div class="wrapper d-flex align-items-stretch">
                ...
                <div id="content" class="p-4 p-md-5">
                    ...
                    <a href="{{ url('/riwayatsk/'.$riwayatsk->pegawai_id) }}" class="btn btn-md btn-success m-2"> Kembali</a>
                    <h1 class="text-center m-2" style="font-size: 30px">FILE SK</h1>
                    <iframe src="/document/{{$data->FILE_SK}}" style="width: 100%; height: 1000px;"></iframe>
                </div>
            </div>
