...
@section('content')
    ...
    <div class="surat_container" data-aos="fade-up" data-aos-delay="50" data-aos-duration="2000">
        <h1 class="h3 mb-0 text-gray-800 mb-2">Penilaian Tahunan</h1>
        <div class="d-flex w-100 justify-content-start pegawai-button gap-3 mb-3">
            <a href="{{ url('/createpenilaiantahunan/'.$pegawai->id) }}" class="btn btn-md btn-success">Tambah</a>
            <a href="{{ url('/dashboardpegawai/'.$pegawai->id) }}" class="btn btn-md btn-info">Back</a>
        </div>
    </div>
    @include ('tabel/tabelpenilaiantahunan', $penilaiantahunan)
    @foreach ($penilaiantahunan as $data)
            ...
            <div class="modal-dialog modal-xl" role="document">
                <div class="modal-content vh-100">
                    ...
                    <div class="modal-body">
                        <iframe src="/document/{{$data->FILE_PENILAIAN}}" class="h-100 w-100 overflow-scroll"></iframe>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="modal-dialog modal-dialog-centered" role="document">
                <div class="modal-content">
                    ...
                    <div class="modal-footer">
                        ...
                        <form action="{{ url('/deletepenilaiantahunan/'.$data->id) }}" method="POST">
                            @csrf
                            @method('DELETE')
